...
List<Item> assetItems = [
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/4T32SaqE_1080x.png",
        const Color(0xFFbcd5e3),
      ),
      ItemDesign(
        "assets/images/products/NUycdIac_1080x.png",
        const Color(0xFFfd8117),
      ),
      ItemDesign(
        "assets/images/products/nji5u8sI_1080x.png",
        const Color(0xFF000000),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/2IrSGXpI_1080x.png",
        const Color(0xFF354f3b),
      ),
      ItemDesign(
        "assets/images/products/btdya6Vs_1080x.png",
        const Color(0xFF69472e),
      ),
      ItemDesign(
        "assets/images/products/DtYmCjWY_1080x.png",
        const Color(0xFF013a5f),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        // "assets/images/products/SAVETHEBEESTEE-WHITE_PINK2_1080x.png",
        "assets/images/products/Hfc948bc6ee034d16b5812d2502e7f726x.png",
        const Color(0xFFe7e9f8),
      ),
      ItemDesign(
        "assets/images/products/SAVETHEBEESTEE-BLACK2_853f9b55-c822-4019-9a36-65f95fca2f58_1080x.png",
        const Color(0xFF000000),
      ),
      ItemDesign(
        "assets/images/products/SAVETHEBEESTEE-SAND2_6dcc692c-2b32-4fec-8995-78538d69e6a3_1080x.png",
        const Color(0xFFbea891),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/WESTERNSHIRTJACKETGREEN1_1080x.png",
        const Color(0xFFf4e9e1),
      ),
      ItemDesign(
        "assets/images/products/WESTERNSHIRTJACKETBLUE1_1080x.png",
        const Color(0xFF161616),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/FW22LOGOSWEATS-BROWN_1080x.png",
        const Color(0xFF644942),
      ),
      ItemDesign(
        "assets/images/products/FW22LOGOSWEATS-YELLOW_1080x.png",
        const Color(0xFFe9c959),
      ),
      ItemDesign(
        "assets/images/products/FW22LOGOSWEATS-MINT_1080x.png",
        const Color(0xFFbacfcc),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/GALAXYCOLLAREDSWEATERGREEN_1080x.png",
        const Color(0xFF4b7c4b),
      ),
      ItemDesign(
        "assets/images/products/GALAXYCOLLAREDSWEATERCAMELIA_1080x.png",
        const Color(0xFFff473a),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/PUZZLECAMOBEANIEGREEN_1080x.png",
        const Color(0xFF477547),
      ),
      ItemDesign(
        "assets/images/products/PUZZLECAMOBEANIEIVORY_1080x.png",
        const Color(0xFFcfbea0),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/3DGOLFNECKLACE_1080x.png",
        const Color(0xFFfabe8a),
      ),
    ],
  ),
  Item(
    ...
    designs: [
      ItemDesign(
        "assets/images/products/FW22NYLONTOTEBAG-YELLOW_1080x.png",
        const Color(0xFFe9c959),
      ),
      ItemDesign(
        "assets/images/products/FW22NYLONTOTEBAG-BROWN_1080x.png",
        const Color(0xFF644942),
      ),
      ItemDesign(
        "assets/images/products/FW22NYLONTOTEBAG-MINT_1080x.png",
        const Color(0xFFbacfcc),
      ),
    ],
  ),
...
class ItemsProvider with ChangeNotifier {
  final List<Item> _items = onlineItems;
